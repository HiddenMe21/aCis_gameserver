	...
	public final void run()
	{
		...
		for (Map.Entry<Player, Integer> entry : _players.entrySet())
		{
			...
			if (skill != null && player.hasSkill(L2Skill.SKILL_SHADOW_SENSE))
			{
				...
				player.sendPacket(SystemMessage.getSystemMessage(_night ? SystemMessageId.NIGHT_S1_EFFECT_APPLIES : SystemMessageId.DAY_S1_EFFECT_DISAPPEARS).addSkillName(L2Skill.SKILL_SHADOW_SENSE));
			}
